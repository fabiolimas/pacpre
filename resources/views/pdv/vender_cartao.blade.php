                            ...
                            <div class="">
                                <div
                                    ...
                                    <h1 class="fs-4 fw-600 mb-4 text-green-2">
                                        <i data-feather="credit-cartd"></i> Cartões Vendidos
                                    </h1>
                                    ...
                                    <table class="table text-green-2 resultBusca">
                                        <thead>
                                            <tr class="fs-18px ">
                                                ...
                                                <th scope="col"><span
                                                        class="text-green-2 d-inline-block pb-3">Opções</span></th>
                                        ...
                                        <tbody>
                                            @foreach ($cartoes as $cartao)
                                                <tr class=" table-tr-cliente fw-500 fs-18px ">
                                                    ...
                                                    <td>
                                                        <span class="text-green "><span style="cursor:pointer"

                                                               ><a href="{{route('pdv.historico', $cartao->id)}}"  title="Histórico"><i class="fa-solid fa-clock-rotate-left"></i></a></span>
                                                            <span style="cursor:pointer" data-bs-toggle="modal"
                                                                data-bs-target="#detalhes-produto-{{ $cartao->id }}"
                                                                title="Baixar"><i class="fa-solid fa-cart-arrow-down"></i></span>
                                                        </span>
                                                    </td>
                                                ...
                                                <div class="modal modal-custom fade"
                                                    id="detalhes-produto-{{ $cartao->id }}" tabindex="-1"
                                                            ...
                                                            <div class="modal-body p-lg-5  border-0">
                                                                ...
                                                                <div class="p-4 shadow rounded-3  bg-white border">
                                                                    ...
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title"> Baixa em cartão pré</h5>

                                                                    </div>

                                                                    <form
                                                                        action="{{ route('pdv.baixar-pontos', $cartao->id) }}"
                                                                        ...
                                                                        <div class="mb-2 pb-3">
                                                                            <div class="mb-0 position-relative">
                                                                                ...
                                                                                <div class="position-relative">
                                                                                    <input type="text"
                                                                                        class="form-control form-control-custom @error('quantidade_atual') is-invallid @enderror fs-18px fw-500"
                                                                                        name="quantidade_atual"
                                                                                        id="quantidade_atual"
                                                                                        value="{{ $cartao->quantidade }}"
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <button type="submit"
                                                                                    ...
                                                                                    class="btn btn-primary w-100 py-2 fs-16px">Baixar</button>
                                                                            </div>
                                                                        </div>
