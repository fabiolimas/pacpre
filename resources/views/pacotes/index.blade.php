                            ...
                            <div
                                ...
                                <div class="">
                                    <a class="btn btn-primary d-block d-md-inline-block mb-3 py-2 px-3   "
                                        href="{{route('pacotes.create')}}" role="button"
                                        style="">
                                    ...
                                    <a class="btn btn-primary d-block d-md-inline-block mb-3 py-2 px-3   "
                                    href="{{route('pacotes.gera-cartoes')}}" role="button"
                                    style="">
                                    <div class="d-flex justify-content-center gap-2 align-items-center py-1">
                                    ...
                                    <tbody>
                                        @foreach ($pacotes as $pacote)
                                            <tr class=" table-tr-cliente fw-500 fs-18px " data-bs-toggle="modal"
                                                data-bs-target="#detalhes-produto-{{ $pacote->id }}"
                                                ...
                                                <td>
                                                    <span class="text-green">R$ {{ number_format($pacote->valor,2,',','.') }}</span>
                                                </td>
                                            ...
                                            <div class="modal modal-custom fade" id="detalhes-produto-{{ $pacote->id }}" tabindex="-1"
                                                                        ...
                                                                        <div class="mb-0 position-relative">
                                                                            ...
                                                                            <div class="position-relative">
                                                                                <input type="text"
                                                                                    ...
                                                                                    name="descricao" id="descricao" value="{{ $pacote->descricao }}"
                                                                                    />
                                                                        ...
                                                                        <div class="mb-0 position-relative">
                                                                            ...
                                                                            <div class="position-relative">
                                                                                <input type="text"
                                                                                    ...
                                                                                    name="quantidade" id="quantidade" value="{{ $pacote->quantidade }}"
                                                                                    placeholder="0" />
                                                                        ...
                                                                        <div class="mb-0 position-relative">
                                                                            ...
                                                                            <div class="position-relative">
                                                                                <input type="text"
                                                                                    ...
                                                                                    name="valor" id="valor" value="{{ $pacote->valor }}"
                                                                                    placeholder="0" />
