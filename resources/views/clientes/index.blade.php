                            ...
                            <div class="">
                                <div
                                    ...
                                    <h1 class="fs-4 fw-600 mb-4 text-green-2">
                                        <i data-feather="user"></i> Clientes
                                    </h1>
                                    <div class="">
                                        <a class="btn btn-primary d-block d-md-inline-block mb-3 py-2 px-3   "
                                            href="{{ route('clientes.create') }}" role="button" style="">
                                        ...
                                        <tbody>
                                            @foreach ($clientes as $cliente)
                                                ...
                                                <div class="modal modal-custom fade"
                                                    id="detalhes-produto-{{ $cliente->id }}" tabindex="-1"
                                                        ...
                                                        <div class="modal-content bg-transparent ">
                                                            <div class="modal-body p-lg-5  border-0">
                                                                ...
                                                                <div class="p-4 shadow rounded-3  bg-white border">
                                                                    ...
                                                                    <form
                                                                        action="{{ route('usuarios.update', $cliente->id) }}"
    ...
    <script>
        $('document').ready(function() {
            ...
            $('#pesquisa').keyup(function() {
                ...
                $.ajax({
                    url: "{{ route('clientes.busca') }}", // Arquivo PHP que processará a busca
                    type: "post",
                    data: {
